...
public class Ellipse extends shape{
    ...
    public Ellipse(Double x, Double y , Double w , Double h) {
         ...
         this.CenterX = x; this.CenterY = y ; 
          ...
          ellipse  = new Ellipse2D.Double(CenterX , CenterY  , w , h);
          double x1 = ellipse.getMaxX();
          double y1 = ellipse.getMaxY();
          double x2 = ellipse.getMinX();
          double y2 = ellipse.getMinY(); 
          rects[0] = new Rectangle2D.Double(x1-S/2, ellipse.getCenterY()-S/2, S, S);
          rects[1] = new Rectangle2D.Double(ellipse.getCenterX()-S/2, y2-S/2, S, S);
          rects[2] = new Rectangle2D.Double(x2-S/2, ellipse.getCenterY()-S/2, S, S);
          rects[3] = new Rectangle2D.Double(ellipse.getCenterX()-S/2, y1-S/2, S, S);
    ...
    public void setshape() {
        ...
        ellipse.setFrameFromCenter(x1, y1, rects[1].getCenterX()-dist1/2, rects[2].getCenterY()-dist2/2);
        setCenter();
      //  repaint();
    }
    ...
    public void setAll(List<Object> x){
        ...
        ellipse = (Ellipse2D.Double)x.get(6);
    }
